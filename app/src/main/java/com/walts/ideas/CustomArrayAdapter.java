...
public class CustomArrayAdapter<T> extends BaseAdapter implements Filterable {
    ...
    private CustomFilter<T> customFilter;
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                try {
                    if (customFilter != null) {
                        newValues = customFilter.filter(values, constraint);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
     ...
     * @param customFilter
     */
    public void setCustomFilter(CustomFilter<T> customFilter) {
    ...
    public interface CustomFilter<T> {
        List<T> filter(ArrayList<T> values, CharSequence constraint) throws Exception;
    }
